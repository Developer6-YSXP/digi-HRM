...
export class ManageJobsComponent implements OnInit {
  ...
  public totalPages = 0;
  public manageJobForm!: FormGroup;
  //** / pagination variables
  ...
  ngOnInit(): void {
    this.getTableData();
    this.manageJobFormInit();
  }

  private manageJobFormInit(): void {
    this.manageJobForm = new FormGroup({
      addJobTitle: new FormControl('', Validators.required),
      addDepartment: new FormControl('', Validators.required),
      addStartDate: new FormControl('', Validators.required),
      addExpireDate: new FormControl('', Validators.required),
  ...
  private getTableData(): void {
    ...
    this.data.getManageJobs().subscribe((res: apiResultFormat) => {
      ...
      this.dataSource = new MatTableDataSource<getManageJobs>(
        this.allManageJobs
      );
