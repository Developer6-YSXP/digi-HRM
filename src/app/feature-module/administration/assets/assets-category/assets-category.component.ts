...
export class AssetsCategoryComponent implements OnInit {
  ...
  selectedList1: data[] = [{ value: 'John Doe' }, { value: 'Richard Miles' }];
  selectedList2: data[] = [
    { value: 'Pending' },
    { value: 'Approved' },
    { value: 'Deployed' },
  ...
  selectedList4: data[] = [{ value: 'Customer' }, { value: 'Client' }];
  ...
  private assestFormInit(): void {
    this.assestForm = new FormGroup({
      assetName: new FormControl('', Validators.required),
      assestId: new FormControl('', Validators.required),
      ...
      assestUser: new FormControl('', Validators.required),
      status: new FormControl('', Validators.required),
    });
  }

  private categoryFormInit(): void {
  ...
  private assignFormInit(): void {
    this.addAssignForm = new FormGroup({
      categoryName: new FormControl('', Validators.required),
  ...
  private getTableData(): void {
    ...
    this.data.getAssetsCategory().subscribe((res: apiResultFormat) => {
      ...
      this.dataSource = new MatTableDataSource<getAssetsCategory>(
        this.assetsCategory
      );
